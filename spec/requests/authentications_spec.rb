...
describe "Authentication" do
  ...
  describe "signin page" do
    ...
    describe "with invalid information" do
      ...
      before do
        fill_in "Email",    with: user.email.upcase #this is upcase to test controllers ability to handle email case insensitivity
